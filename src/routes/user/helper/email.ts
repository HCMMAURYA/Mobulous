export const emailTemp = (pass:string)=>{
                          ...
                          <tr>
                             <td align="center" valign="top">
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%">
                                   <tr>
                                      <td class="hero-bg">
                                         <table cellspacing="0" cellpadding="0" width="100%" bgcolor="223e9c">
                                            <tr>
                                   ...
                                   <tr>
                                      <td style="background-color:#ffffff;">
                                         ...
                                         <center>
                                            <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                               ...
                                               <tr>
                                                  ...
                                                  <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                     <div style="line-height: 24px">
                                                        <strong style="color: #223e9c; font-weight: 700;">Step 1. Copy your password:</strong>
                                                        <br>
                                                        <p style="    border: 1px solid #223e9c;
                                                        border-style: dashed;
                                                        width: 188px;
                                                        padding-left: 10px;" > ${pass} </p>
                                               ...
                                               <tr>
                                                  ...
                                                  <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                     <div style="line-height: 24px">
                                                        <strong style="color: #223e9c; font-weight: 700;">Step 2. Login to your account:</strong><br>
                                                     </div>
                                                  </td>
                                               </tr>
                                                     ...
                                                     <tr>
                                                        <td>
                                                           <div>
                                                              ...
                                                              <a href="https://ondc-hul.herokuapp.com/login" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;">Login &rarr;</a>
                                                           </div>
                                                        </td>
                                                     </tr>
                                                  </table>
                                         ...
                                         <table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="force-full-width">
                                            ...
                                            <tr>
                                               <td align="center">      
                                                  <img src="http://localhost:3000/img/logemail.jpg" style="display: block; width: 100%;" width="100%" border="0" alt=""/>
                                               </td>
                                            </tr>
                                            </td>      
                                            </tr>      
                                         </table>
                                         <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                            <tr>
                                               <td align="center">
                                                  <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                                     <tr>
                                                     <tr>
                                                        ...
                                                        <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                                           ...
                                                           <tr>
                                                              <td align="center" style="color: #FFFFFF;" >
                                                               Need help? please reach to 2121212111
                                                              </td>
                                                           </tr>
                                                           </td>
                                                           </tr>
...
export const forgetEmailTemp = (token:string)=>{
   return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
   <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
         <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
                                                   ...
                                                   <tr>
                                                      <td>
                                                         <div>
                                                            ...
                                                            <a href="https://ondc-hul.herokuapp.com/reset-password/${token}" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;" target="_blank" >Reset your pasword</a>
                                                         </div>
                                                      </td>
                                                   </tr>
                                                </table>
                                                ...
                                                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                                   ...
                                                   <td align="center">
                                                      <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                                         ...
                                                         <tr>
                                                            <td align="center" style="color: #FFFFFF;" >
                                                             Need help? please reach to 2121121121212
                                                            </td>
                                                         </tr>
                                                         </td>
                                                         </tr>
