export const orderCreateMail = (name:string,title:string, totalPrice:string,orderId:string,)=>{
                         ...
                         <tr>
                            <td align="center" valign="top">
                                  ...
                                  <tr>
                                     <td class="hero-bg">
                                        <table cellspacing="0" cellpadding="0" width="100%" bgcolor="223e9c">
                                           <tr>
                                              <td height="25" style="font-size: 30px; line-height: 30px;" class="desktop-hide">&nbsp;</td>
                                           </tr>
                                           <tr>
                                              <td style="font-size:30px; font-weight: 200; color: #ffffff; text-align:center;">
                                                 ...
                                                 Welcome to ONDC | VLCC
                                                 
                                                 <br>
                                               
                                                 <p>Your Order Created Successfully..</p>
                                              </td>
                               ...
                               <table cellspacing="0" cellpadding="0" class="force-full-width" bgcolor="#ffffff" >
                                         ...
                                         <br>
                                         <p class="details" style="padding-left: 5%;"> 
                                      
                                         Dear <b>${name}</b>,<br>
                                         <br>
                                         Thank you for shopping at ONDC-B2C.
                                         <br><br>
                                         We confirm your order <b>${orderId}</b> ${title}</p>
                                          <p style="padding-left: 5%;">Item Summery</p>

                                          <table " border="2" align="center" cellpadding="1" cellspacing="1" bgcolor="ffffff" style="width:80%">
                                            <tr>
                                               <td style="padding-left: 10px;" >OrderId</td>  
                                               <td style="padding-left: 10px;" >Order Item</td> 
                                                       ...
                                                       <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="223e9c">
                                                          ...
                                                          <tr>
                                                             <td align="center" style="color: #FFFFFF;" >
                                                              Need help? please reach to support@ens.enterprises
                                                             </td>
                                                          </tr>
                                                          </td>
                                                          </tr>
